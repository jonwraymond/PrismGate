...
- `prismgate` is the binary, package, config directory, socket prefix, and MCP server name.
...
- [Tool Discovery](tool-discovery.md): the 13 meta-tools, three-tier search (BM25 → trigram → fuzzy), optional semantic search
...
- [Resources & Prompts](resources-and-prompts.md): live `prismgate://` resources and MCP prompts
