...
fn registry() -> &'static Registry {
    REG.get_or_init(|| {
        ...
        let tools = [
            (
                "search_tools",
                "search and filter MCP tools by name or description",
            ),
            (
                "list_tools_meta",
                "list all tools with metadata including descriptions and schemas",
            ),
            (
                "tool_info",
            ...
            (
                ...
                "get the required authentication keys for a tool",
            ),
            (
                "call_tool_chain",
            ...
            (
                "register_manual",
                "manually register a tool with name and description",
            ),
            (
                "deregister_manual",
                "remove a manually registered tool from the registry",
            ),
            ...
            (
                "http_post",
                "perform HTTP POST request with JSON body to a URL",
            ),
            (
                "database_query",
            ...
            (
                "memory_recall",
                "recall a previously stored value from memory",
            ),
            (
                "eval_python",
            ...
            (
                "slack_post",
                "post a message to a Slack channel via webhook or API",
            ),
            ...
            (
                "graphql_query",
                "execute a GraphQL query against a configured endpoint",
            ),
            (
                "rate_limit_check",
                "check if a rate limit has been exceeded for a key",
            ),
            (
                "cache_invalidate",
            ...
            (
                "config_get",
                "get a configuration value by key from config store",
            ),
            (
                "config_set",
                "set a configuration value in the config store",
            ),
            (
                "health_check",
                "check health status of all registered backends",
            ),
            ("metrics_get", "retrieve current metrics from the gateway"),
            ("logs_tail", "tail recent log entries from the gateway"),
            (
                "trace_get",
                "get a trace by its ID from the tracing backend",
            ),
            (
                "user_authenticate",
            ...
            (
                "queue_publish",
                "publish a message to a message queue topic",
            ),
            (
                "queue_consume",
                "consume messages from a queue consumer group",
            ),
            ...
            (
                "feature_flag_get",
                "get the value of a feature flag by name",
            ),
        ];
